...
// apresente no console os dados dos pokemons
// DESAFIO:

for (let i = 0; i <= pokemonsNames.length - 1; i++) {
  let pokemonsNamesNoTypes = pokemonsNames[i];
  console.log(`${pokemonsNamesNoTypes.name} \n`);
  console.log(`${pokemonsNamesNoTypes.description} \n`);
  console.log(`${pokemonsNamesNoTypes.art_url} \n`);

  console.log("*******************************************");
  let listaTipos = pokemonsNamesNoTypes.types;
